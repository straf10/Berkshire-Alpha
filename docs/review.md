...
The historical data confirms the mechanism: the only two band-compliant credit plans ever built are id 32 (SPY, δ 0.2715) → **`NEGATIVE_EDGE`**, and id 38 (TSLA, δ 0.2754) → `f* = 0.0318`, barely positive. Meanwhile every out-of-band LLM plan cleared comfortably.
